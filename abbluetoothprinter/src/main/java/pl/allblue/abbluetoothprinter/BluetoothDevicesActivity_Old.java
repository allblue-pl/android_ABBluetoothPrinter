...
//
//
//public class BluetoothDevicesActivity_Old extends ListActivity {
//
...
//            int[] device_classes) {
//        Intent intent = new Intent(activity, BluetoothDevicesActivity_Old.class);
//        intent.putExtra(BluetoothDevicesActivity_Old.Extras_SupportedDeviceClasses,
//                device_classes);
//
...
//            return;
//
//        this.devicesAdapter = new ArrayAdapter<>(this, R.layout.item_bluetooth_device);
//        this.setListAdapter(this.devicesAdapter);
//
//        final BluetoothDevicesActivity_Old self = this;
...
//        });
//        this.devices.startDiscovery(this);
...
//                .getIntArray(BluetoothDevicesActivity_Old
...
//            intent.putExtra(BluetoothDevicesActivity_Old.Result_Device,
